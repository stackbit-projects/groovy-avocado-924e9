  ...
  - type: features_section
    ...
    features:
      - title: 디자이너의 가장 큰 고민은 수량에 따른 가격 입니다
        ...
        content: >+
          팝스터는 의류 디자인 크라우드 펀딩을 통해 최소 오더 수량 (MOQ) 에 도달후 생산에 투입됩니다. 적은 수량의 경우 판매
          시도조차 하지 못했던 기존의 의류 제조 방식을 벗어나 원하는 디자인의 기획과 생산후 납품 까지를 한번에 해결하는 의류 제조
          솔루션 플랫폼입니다
      ...
      - title: 간단했나요? 여러분의 작업지시서?
        content: >
          쉬운 작업지시서가 아니면, 공장과의 의사소통이 어렵습니다. 팝스터의 작업지시서는 사진들로 쉽고 빠르게 만들어 원하는 봉제
          컨스트럭션및 디자인 의도를 공장에 정확히 전달할수 있습니다.
        actions:
          - label: Learn More
            url: /style-guide
            style: primary
